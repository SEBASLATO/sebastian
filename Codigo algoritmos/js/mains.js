...
function opBasicas (){
    ...
    alert("el resultado de la suma es: " + S + " ,el resultado de la resta es: " + R + " ,el resultado de la divison es: " + D + " ,el resultado de la multiplicacion es: " + M);
...
function cuadrado(){
    ...
    C = A + A;
    alert("El cuadrado del valor digitado es: "+ A);
...
function metrosacentimetrosypulgadas(){
    ...
    let C=0;
    let P=0;
    M=parseInt(prompt("Ingrese los metros que quiere comvertir a centimetros y pulgadas"));
    C= M *100;
    P= M *39.3701;
